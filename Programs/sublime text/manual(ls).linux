...
DESCRIPTION
 ...
 -s, --size
       ...
       -u     with -lt: sort by, and show, access time; with -l: show ac‐
              cess time and sort by name; otherwise: sort by access time,
              newest first
...
GNU coreutils 8.30             August 2019                          LS(1)
 ...
 Manual page ls(1) line 221/246 (END) (press h for help or q to quit)
